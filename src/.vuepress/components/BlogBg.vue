...
const BlogBg = () => {
    if (!document.getElementById('BlogBg')) {
...
const CanvasNest = () => {
    // 创建 dom
    if (!document.getElementById('bg_canvas_nest')) {
        const canvasElm = document.createElement('canvas');
        canvasElm.id = 'bg_canvas_nest';
    ...
    if (!document.getElementById('canvas_nest_js')) {
        ...
        jsElm.src = '/painlife/js/canvas-nest.js';
...
const GrainParallax = () => {
    // 插入 css
    if (!document.getElementById('grain_parallax_css')) {
        const cssElm = document.createElement('link');
        cssElm.type = 'text/css';
        cssElm.rel = 'stylesheet';
        cssElm.href = '/painlife/js/grain-parallax.css';
        cssElm.id = 'grain_parallax_css';
        document.body.appendChild(cssElm);
    }

    // 创建 dom
    if (!document.getElementById('bg_grain_parallax')) {
        const boxElm = document.createElement('div');
        boxElm.id = 'bg_grain_parallax';
...
<div id="particles-foreground"></div>
    ...
    if (!document.getElementById('grain_parallax_js')) {
        ...
        jsElm.type = 'text/javascript';
        jsElm.src = '/painlife/js/grain-parallax.js';
        document.body.appendChild(jsElm);
    }
};
